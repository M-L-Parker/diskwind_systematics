...
parset_file=open("simulated_spectra_2/athena_hybrid/parameters.txt",'w')
...
for i in range(0,N):
	...
	if not os.path.exists("simulated_spectra_2/athena_hybrid/"+filename):
		...
		os.rename(filename,"simulated_spectra_2/athena_hybrid/"+filename)
		os.rename(backfilename,"simulated_spectra_2/athena_hybrid/"+backfilename)


	print('Binning spectrum...')
	binnedfilename='.'.join(filename.split('.')[:-1])+'_binned_const.pha'

	if not os.path.exists('simulated_spectra_2/athena_hybrid/'+binnedfilename):
		...
		os.rename("simulated_spectra_2/athena_hybrid/"+filename,filename)
		os.rename("simulated_spectra_2/athena_hybrid/"+backfilename,backfilename)
		...
		os.rename(filename,"simulated_spectra_2/athena_hybrid/"+filename)
		os.rename(binnedfilename,"simulated_spectra_2/athena_hybrid/"+binnedfilename)
		os.rename(backfilename,"simulated_spectra_2/athena_hybrid/"+backfilename)
