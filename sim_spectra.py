...
parset_file=open("simulated_spectra_2/xmm_hybrid/parameters.txt",'w')
...
for i in range(0,N):
	...
	filestem=str(i)
	filename="fakespec_"+filestem+"_xmm_hybrid.pha"
	backfilename="fakespec_"+filestem+"_xmm_hybrid_bkg.pha"
	if not os.path.exists("simulated_spectra_2/xmm_hybrid/"+filename):
		...
		os.rename(filename,"simulated_spectra_2/xmm_hybrid/"+filename)
		os.rename(binnedfilename,"simulated_spectra_2/xmm_hybrid/"+binnedfilename)
		os.rename(backfilename,"simulated_spectra_2/xmm_hybrid/"+backfilename)
